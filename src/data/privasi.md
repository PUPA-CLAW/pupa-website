...
* Mengunjungi situs web kami di pupacenter.org;
* Menghubungi PUPA melalui saluran WhatsApp atau Telegram kami;
* Merupakan orang tua, wali, atau anggota keluarga dari seseorang yang terdaftar di PUPA atau sedang mencari informasi tentang PUPA;
* Merupakan calon peserta, mitra, donatur, relawan, atau anggota masyarakat yang menghubungi kami.
...
* **Tanpa pelacakan.** Kami tidak menggunakan cookie iklan, layanan analitik, atau skrip pelacak dalam bentuk apa pun.
* **Data teknis.** Penyedia hosting kami (Cloudflare) memproses informasi teknis standar — seperti alamat IP dan halaman yang diminta — sebatas yang diperlukan untuk menayangkan situs secara aman dan andal. Kami tidak menggunakan informasi ini untuk mengidentifikasi pengunjung.
* **Font.** Halaman kami memuat font dari Google Fonts, sehingga peramban Anda mengirimkan permintaan standar (termasuk alamat IP Anda) ke server Google. Hal ini tunduk pada kebijakan privasi Google.
...
* **Informasi kontak:** nomor telepon Anda, nama (atau nama yang Anda berikan kepada kami), dan saluran pesan yang Anda gunakan.
* **Isi pesan:** pesan yang Anda kirimkan kepada kami beserta balasan kami, untuk keperluan menanggapi Anda dan menyediakan layanan kami.
...
* Kami **tidak** menyimpan diagnosis, kondisi medis, detail pengobatan, catatan terapi, atau detail insiden perilaku dalam catatan kontak otomatis kami.
...
* Menanggapi pertanyaan Anda dan menyediakan layanan pendampingan kami;
* Mengoordinasikan jadwal, kehadiran, dan logistik program bagi keluarga yang terdaftar;
* Mengirimkan notifikasi layanan (seperti pembaruan kehadiran) kepada keluarga yang telah menyetujuinya;
* Meneruskan pertanyaan Anda kepada staf PUPA yang tepat;
* Menyimpan catatan komunikasi agar tim kami dapat membantu Anda secara efektif;
* Mencatat dan mempertanggungjawabkan donasi;
...
* **Di dalam tim PUPA,** kepada staf yang membutuhkannya untuk membantu Anda;
* **Kepada penyedia layanan** yang membantu operasional kami (misalnya penyedia platform pesan serta penyedia hosting/penyimpanan yang aman), dengan ketentuan kerahasiaan dan pelindungan data yang memadai, dan hanya sebatas yang diperlukan;
* **Bila diwajibkan oleh hukum,** untuk memenuhi permintaan yang sah dari aparat penegak hukum atau otoritas yang berwenang sesuai peraturan perundang-undangan, atau untuk melindungi keselamatan seseorang bila kami meyakini dengan iktikad baik terdapat risiko bahaya serius.
...
* **Catatan komunikasi** disimpan selama diperlukan untuk menyediakan dan mempertanggungjawabkan layanan kami, kemudian dihapus atau dianonimkan.
* **Ringkasan kontak** disimpan selama hubungan masih aktif dan dihapus atau dianonimkan bila tidak lagi diperlukan. Kami menggunakan soft-deletion untuk menjaga integritas audit yang diperlukan sebelum penghapusan permanen.
...
* **Menarik persetujuan** serta meminta kami **menghentikan pemrosesan** atau **menghapus** data Anda, dengan memperhatikan kewajiban penyimpanan menurut hukum;
* **Mengajukan keberatan** atas pemrosesan tertentu;
* **Menyampaikan pengaduan** kepada otoritas yang berwenang.
...
*Kebijakan ini mencerminkan praktik kami per tanggal di atas serta komitmen kami untuk menangani data pribadi Anda secara bertanggung jawab sesuai Undang-Undang Pelindungan Data Pribadi (UU No. 27 Tahun 2022).*
