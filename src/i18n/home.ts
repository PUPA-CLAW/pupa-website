...
export const home: Record<Lang, any> = {
  en: {
    ...
    photoPlaceholder: 'Photo placeholder: a learner at work during a Karya workshop',
    ...
    ways: [
      { strong: 'Bank transfer', rest: ' — account details listed here (placeholder)' },
      { strong: 'QRIS', rest: ' — scan-to-give code displayed here (placeholder)' },
  ...
  id: {
    ...
    photoPlaceholder: 'Tempat foto: peserta sedang bekerja dalam lokakarya Karya',
