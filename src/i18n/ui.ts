...
export const ui = {
  en: {
    ...
    'nav.about.mission': 'Vision, Mission & Values',
  ...
  id: {
    ...
    'nav.about.mission': 'Visi, Misi & Nilai',
    'nav.about.team': 'Tim Kami',
    'nav.about.board': 'Dewan Yayasan',
  ...
  ko: {
    ...
    'nav.about.mission': '비전·미션·가치',
    'nav.about.team': '팀 소개',
    'nav.about.board': '재단 이사회',
...
export const routes: Record<string, { en: string; id: string; ko: string }> = {
  ...
  terms:           { en: '/terms/',                  id: '/id/ketentuan/',          ko: '/ko/terms/' },
};
