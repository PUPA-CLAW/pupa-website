...
export const ui = {
  en: {
    ...
    'footer.ctaBlurb': 'Whether you are considering enrolling, want to know more about our programs, or simply want to get to know PUPA Center — we would be glad to help.',
  ...
  id: {
    ...
    'footer.ctaBlurb': 'Baik Anda sedang mempertimbangkan untuk mendaftar, ingin tahu lebih lanjut tentang program kami, atau sekadar ingin mengenal PUPA Center — kami dengan senang hati membantu.',
